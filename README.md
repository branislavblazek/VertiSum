...
This is a serverless webhook for Strava. It automatically updates your Strava activity descriptions with your Year-to-Date (YTD) elevation gain. Only triggers for foot activities (`Run`, `TrailRun`, `Hike` and `Walk`).
